                ...
                <div class="product font-poppins">
                    ...
                    <div class="text-first py-3">
                        ...
                        <form method="post">
                            ...
                            <button type="submit" name="featured_submit" class="btn btn-add font-s-12 font-w-700">ADD TO
                                CART</button>
                        </form>
                    </div>
                </div>
...
<div class="text-center">
    <a href="products.html" class="text-center btn btn-coll font-poppins font-w-600 mb-5">LOAD MORE
